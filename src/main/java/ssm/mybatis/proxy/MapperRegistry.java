...
public class MapperRegistry
{
    ...
    {
      MapperProxyFactory<T> mapperProxyFactory = (MapperProxyFactory<T>)this.knownMappers.get(type);//获取代理工厂
      
      return mapperProxyFactory.newInstance(sqlSession);//为代理工厂提供sqlSession,从而创建代理对象
    }
