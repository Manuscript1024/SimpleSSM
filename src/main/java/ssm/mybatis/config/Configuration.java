 ...
 * 
 */
package ssm.mybatis.config;

import ssm.mybatis.data.MappedStatement;
import ssm.mybatis.proxy.MapperRegistry;
...
public class Configuration
{
    ...
    {
      return this.mapperRegistry.getMapper(type, sqlSession);//dao.class , update/delete/insert-method
    }
